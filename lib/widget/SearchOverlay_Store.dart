...
class SearchOverlay_Store extends StatefulWidget {
  String url;

  SearchOverlay_Store({this.url});

  @override
  State<StatefulWidget> createState() => SearchOverlay_StoreState();
}

class SearchOverlay_StoreState extends State<SearchOverlay_Store>
                                ...
                                itemBuilder: (context) => [
                                  ...
                                  PopupMenuItem(
                                    ...
                                    child:  InkWell(
                                      onTap: (){
                                        API(context)
                                            .Delete("stores/${products[index].id}")
                                            .then((value) {
                                          showDialog(
                                            context: context,
                                            builder: (_) => ResultOverlay(
